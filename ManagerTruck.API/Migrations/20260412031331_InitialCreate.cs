        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CaminhaoEntityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CaminhaoHistoricoEntity", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CaminhaoHistoricoEntity_Caminhoes_CaminhaoEntityId",
                        column: x => x.CaminhaoEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CaminhaoHistoricoEntity_CaminhaoEntityId",
                table: "CaminhaoHistoricoEntity",
                column: "CaminhaoEntityId");
        }
